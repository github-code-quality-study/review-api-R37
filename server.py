...
valid_locations = [
    ...
    "Denver, Colorado",
    # Add other valid locations here
]

# Debug: Check if the file exists
if os.path.exists('data/reviews.csv'):
    print("File found: data/reviews.csv")
else:
    print("File not found: data/reviews.csv")
...
class ReviewAnalyzerServer:
    ...
    def __call__(self, environ: dict[str, Any], start_response: Callable[..., Any]) -> bytes:
        if environ["REQUEST_METHOD"] == "GET":
            ...
            print(f"GET request with params: location={location}, start_date={start_date}, end_date={end_date}")
            ...
            # Debug: Print number of filtered reviews
            print(f"Number of filtered reviews: {len(filtered_reviews)}")
